...
import static de.lexej.VNFP.model.NetworkGraph.noDigits;
...
public class TrafficRequest implements Comparable<TrafficRequest> {
    ...
    public String toOldCsvFormat() {
        String ret = "0,"+ingress.name+","+egress.name+","+noDigits(bandwidthDemand*1000.0)+","+noDigits(expectedDelay)+",0.00000010";
        for (VNF vnf : vnfSequence) {
